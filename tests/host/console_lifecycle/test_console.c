...
#define CONFIG_SLIMEVR_USB_DEVICE_PRODUCT "receiver"
...
/* Worker scheduling is controlled by dequeue + production admission gate below. */
...
int main(void)
{
    ...
    puts("receiver production console lifecycle: PASS");
    return 0;
}
